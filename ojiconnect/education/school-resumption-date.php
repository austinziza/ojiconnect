<html>
<head>
<title> SCHOOLS TO RESUME BY OCTOBER</title>
...
<a href="index.html"><img src = "css/header.jpg" alt="ojiconnect.com"></img></a>
<br><br>

<div class="advert">
<a href="../advert.html"><img src="img_education/advert2.jpg" alt="PLACE YOUR ADVERT HERE" width="100%"></img></a>
</div>

<div class="nav-heading" align="center">

<a href="../index.html"><span class="homebtn"> HOME PAGE</span></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<a href="../education-page.html"><span class="sports"> EDUCATION</span></a>


</div>
<br><br>
<div class="heading" align="center">
<b>SCHOOL TO RESUME BY OCTOBER: MINISTER OF EDUCATION</b><br>
   <span class="date-of-post"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;June 25 2020 </span>
</div>

<div class="maincontent" align="center">
<img src="img_education/minister.jpg" alt="education resumption date" height="300" width="400" ></img>
<p>

Through its first two years, the Trump administration has concentrated on two issues in its relationship with China: North Korea and trade. While it has secured Chinese buy-in for a new diplomatic framework for dialogue, the administration does not appear to have settled on an overarching China strategy. So far, there have been no major speeches or articles by senior foreign affairs officials on China or Asia, with the partial exception of an address by Defense Secretary Mattis in Singapore on regional military issues.
Until a strategy is set, there will continue to be confused and conflicting messages from different quarters of the United States government on China, disagreement and sloppiness on proper sequencing of actions, and limits to our ability to elicit Chinese cooperation, as Beijing hesitates to commit to U.S. initiatives because of uncertainty over the steadfastness and coherence of U.S. policy.<br><br>
...
<div class="leave-a-comment" align="center">
...
//dont forget to define the articleid variable
$article_id = 1;
...
$sql= "
SELECT * FROM `comments` WHERE `articleid` = 1 ORDER BY `articleid` DESC  " ;
...
<a href="www.facebook.com/ojiconnect"><h2><font color="#2F4F4F"> FACEBOOK</font></h2></a>
<a href="www.instagram.com/ojiconnect"><h2> <font color="#2F4F4F">INSTAGRAM</font></h2></a>
<a href="www.twitter.com/ojiconnect"><h2><font color="#2F4F4F"> TWITTER</font></h2></a>
<a href="www.youtube.com/ojiconnect"><h2><font color="#2F4F4F"> YOUTUBE</font></h2></a>
<hr width="100%" size="3" noshade />
</div>
<div class="contactus2" align="center">
<h2>EMAIL:&nbsp; ojiconnect2020@gmail.com</h2>
<h2> CONTACT US ON TEL: +234 8178624677</h2>
</div>
<hr width="100%" size="3" noshade />

<div class="aboutus" align="center">
<a href="../aboutus.html">ABOUT US</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="../advert.html">  ADVERTIZE WITH US</a>&nbsp;&nbsp;&nbsp;&nbsp;<A href="yourarticle.html">SEND US YOUR STORY</a>
</div>
